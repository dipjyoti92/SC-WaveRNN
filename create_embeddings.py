...
if __name__ == '__main__':
    ...
    #path_wav = "/home/dipjyoti/LJSpeech-1.1/wavs_22.05_tts/"
    #path_embed = "/home/dipjyoti/WaveRNN-master_vctk_spk_embed_tts_except_10/data/spk_embeds/"
    path_wav = '/media/hdd2/dipjyoti/TransformerTTS/ref_audio/'
    path_embed = '/media/hdd2/dipjyoti/TransformerTTS/ref_audio/'
    ...
    try:
        ...
        for filename in glob.glob(os.path.join(path_wav, '*.wav')):
            print(filename)
